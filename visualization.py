...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualization of DA-MIST.")
    parser.add_argument('--input', type=str, default="demo/videos/BLEED&BLUR.mp4", help="Path to the input video.")
    parser.add_argument('--output', type=str, default="demo/results/VIS_BLEED&BLUR.mp4", help="Path to save the visualized output video.")
    parser.add_argument('--extractor_weights', type=str, default="extractors/weights/fti3d.pth", help="Path to the extractor weights.")
    parser.add_argument('--detector_weights', type=str, default="weights/stage2_trans_3407.pkl", help="Path to the detector weights.")
    
    args = parser.parse_args()
    input_path = args.input
    output_path = args.output
    extractor_weights_path = args.extractor_weights
